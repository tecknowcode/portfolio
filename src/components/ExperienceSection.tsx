...
const experiences = [
  {
    ...
    type: "current",
    achievements: [
      "Delivered impactful AI and data-driven solutions for diverse business use cases.",
      "Maintained strong client satisfaction through reliable and scalable project execution.",
